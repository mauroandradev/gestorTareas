      ...
      <div className="flex flex-col flex-1 overflow-y-auto">
        ...
        <div className="h-16 px-space-lg flex items-center gap-space-sm border-b border-surface-container-low/50">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] uppercase font-semibold text-primary tracking-widest"></span>
          </div>
        </div>
        ...
        <div className="px-space-md mb-space-xs">
          <span className="px-space-sm text-[11px] font-semibold uppercase tracking-wider text-outline">
            Plataforma
          </span>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                <span
                  className={`material-symbols-outlined text-[20px] ${isActive ? "text-on-primary" : "text-outline"}`}>
                  {item.icon}
                </span>
          ...
          {projects.map((proj) => {
            ...
            return (
              <button
                ...
                <div className="flex items-center gap-space-sm min-w-0">
                  <span
                    className={`w-2.5 h-2.5 rounded-full ${colorClass} shrink-0`}></span>
